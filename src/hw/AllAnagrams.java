 ...
 * Examples
 *
 * l = "abcbac", s = "ab", return [0, 3] since the substring with length 2 starting from index 0/3 are all anagrams of
 * "ab" ("ab", "ba").
 */
...
class Solution {
	  public List<Integer> allAnagrams(String s, String l) {
	    ...
	    // move slow pointer to make map[char] == 0, also update totalCount, then check map
	    // till fast hit end    
