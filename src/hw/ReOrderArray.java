...
public class ReOrderArray {
	...
	////////////////////////////
	// self: using string builder
	public int[] reorder_self(int[] array) {
		...
		for (int i = 0; i < mid; i++) {
			result[i * 2] = array[i];
			result[i * 2 + 1] = array[mid + i];
		}
		// for the last index (not necessary for even length, but need to do for odd length
