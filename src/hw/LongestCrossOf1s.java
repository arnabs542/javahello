...
/**
 * Longest Cross Of 1s Description Given a matrix that contains only 1s and 0s,
 * find the largest cross which contains only 1s, with the same arm lengths and
...
public class LongestCrossOf1s {
	public int largest(int[][] matrix) {
		...
		// rightdown records the longest possible length for the right and down
		// arms ending at each cells in the matrix.
